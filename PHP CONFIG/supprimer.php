...
<header class="navbar navbar-expand-lg navbar-light bg-light wrap mb-1">
  ...
  <a class="navbar-brand" href="#">DUCA</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="../PHP CONFIG/admin.php">Nouveau</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" style="font-weight: bold;" href="../PHPCONFIG/supprimer.php">Suppression</a>
        </li>
        </li>
                <li class="nav-item">
        ...
        <div class="col">
          <div class="card shadow-sm">
            ...
            <img src="<?= $produit->image ?>">
             ...
             <h3><?= $produit->id?></h3>  
            <!--mettre le nom des article au lieux de numéro  -->
